...
export class TodolistService {
  ...
  //To do
  //Define the route address to the server...!ok..I did it!

  private url_get = 'http://localhost:3000/api/get_items';
  private url_post = 'http://localhost:3000/api/add_item';
  private url_put = 'http://localhost:3000/api/edit_item';
  private url_delete = 'http://localhost:3000/api/delete_item';
